      ...
      <div className="lg:flex block">
        <div className="lg:w-[620px] w-full">
          <h1 className="flex space-x-8">
            <span className="text-cool-grey lg:text-headline-medium text-product-card">Address</span>
          ...
          <div className="mt-14 mx-5">
           ...
           <table className="w-full mt-5 border border-cool-grey border-b-0">
            <tr className="flex justify-between text-center py-2 px-3 border-b border-cool-grey">
              ...
              />
              <h1 className="mx-3 text-label-medium flex align-bottom">Free</h1>
              <h1 className="mx-2 text-body-large">Regular Shipment</h1>
                </div>
                <h1 className="mx-3 text-label-medium flex align-bottom">01 Feb, 2023</h1>
            </tr>
            <tr className="flex justify-between text-center py-2 px-3 border-b border-cool-grey">
                <div className="flex">
                <input
                ...
                className="w-4 h-4 mt-1 mx-2"
              />
              <h1 className="mx-3 text-label-medium flex align-bottom">$8.50</h1>
              <h1 className="mx-2 text-body-large">Priority Shipment</h1>
                </div>
                <h1 className="mx-3 text-label-medium flex align-bottom">01 Feb, 2023</h1>
            </tr>
            <tr className="flex justify-between text-center py-2 px-3 border-b border-cool-grey">
                ...
                className="w-4 h-4 mt-1 mx-2"
              />
              <h1 className="mx-3 text-label-medium flex align-bottom">Schedule</h1>
              <h1 className="mx-2 text-body-large">Choose a date that works for you</h1>
                </div>
                <h1 className="mx-3 text-label-medium text-cool-grey">Select Date</h1>
            </tr>
           </table>
          </div>
        </div>
