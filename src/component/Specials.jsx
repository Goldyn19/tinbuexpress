...
const Specials = () => {
  return (
    <div className="h-[500px] md:h-auto w-full  bg-cover relative  bg-left my-10 flex  items-center justify-center md:justify-normal " style={{ backgroundImage: `url(${pic1})` , aspectRatio:3/1 }}>
      <div className='bg-white opacity-90 w-[348px] flex  absolute md:left-28 mx-auto h-[224px] md:w-[314px] lg:h-[338px] lg:w-[545px]'>
        <div className='flex flex-col md:mx-auto my-auto justify-center mx-3  w-[347px] h-[224px] md:w-[314px] lg:h-[217px] lg:w-[312px]'>
